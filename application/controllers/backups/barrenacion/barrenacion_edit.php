      ...
      <div class="box">
        ...
        <div class="box-body ">
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="text" class="form-control" name="zona" id="zona" value="<?= $all_barrenacion_id['zona'] ?>" style="width:180px;">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="number" min="0" class="form-control" name="linea" id="linea" value="<?= $all_barrenacion_id['linea'] ?>" style="width:180px;">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <?php if ($all_barrenacion_id['paro'] != 0) : ?>
                Si&nbsp;&nbsp;<input type="radio" name="paro" id="si" value="<?= $all_barrenacion_id['paro'] ?>" checked>&nbsp;&nbsp;
                No&nbsp;&nbsp;<input type="radio" name="paro" id="no" value="0">
              <?php elseif($all_barrenacion_id['paro'] == 0): ?>
                ...
                <div class="razones align-razones">
                  <select name="razon_id" id="" class="form-control" style="width:180px;">
                    ...
                    <?php foreach ($razones as $razon) : ?>
                      ...
                      <?php
                      $selected = "";
                      if ($all_barrenacion_id['razon_id'] == $razon['id']) {
                        $selected = "selected";
                      ?>
                      <?php } ?>

                      <option value="<?= $razon["id"]; ?>" <?php echo $selected; ?>><?= $razon['nombre']; ?></option>

                    <?php endforeach; ?>
                  </select>
                  <?php //var_dump($razones);   
                  ?>
                  <!-- 
                  ...
                  <div class="paro-div align-paro">
                    ...
                    <input type="number" value="<?= $all_barrenacion_id['horas_paro'] ?>" step="0.5" name="horas_paro" class="form-control col-md-2 horas_mod" min="0" max="24" style="width:65px;">
                  </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <textarea name="observaciones" class="form-control comments-box" id=""><?= $all_barrenacion_id['observaciones'] ?></textarea>
            </div>
          </div>
