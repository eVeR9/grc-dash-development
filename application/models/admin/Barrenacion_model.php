...
class Barrenacion_model extends CI_Model {
    ...
    public function get_all_barrenacion() {
        $this->db->select('b.id, b.fecha, concat(rhe.nombre, " ", rhe.apellidos) as empleado_id, bm.nombre as maquina_id, rhe.id_puesto, ayudante_id, b.plantilla, b.metros_perf, b.bar_perf, b.bar_por_volar, (b.metros_perf*b.plantilla)*2.7 as tons_tumbe, br.nombre as razon_id, horas_paro, zona, linea');
        ...
        $this->db->join('barreno_maquina bm', 'b.maquina_id = bm.id', 'left');
    ...
    public function get_empleados_barrenacion(){
        ...
        $qry = "SELECT * FROM rh_empleados WHERE id_puesto = 75 OR id_puesto = 76 AND fecha_de_baja is null";
