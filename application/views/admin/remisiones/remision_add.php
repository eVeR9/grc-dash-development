      ...
      <div class="box">
        ...
        <div class="box-body ">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <!-- esconder para bascula -->
			  ...
			  if($depto == "TI" || $depto == "VENTAS")
			  {
				...
				$esconder_div="style='display:none'";
			  }
			  ?>
			...
			<?php echo form_open(base_url('admin/remisiones/add/'), 'class="form-horizontal"' )?>            
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" autocomplete="off" name="fecha_remision" class="form-control" id="datepicker" required>
                  </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <select name="serie" id="serie" class="form-control" required>
                    ...
                    <?php if($puesto == "ESPUELA") {?>
                    <option value="E" data-value="E">Serie E</option>
                    <?php } elseif ($depto == "MINA" && $puesto <> "ESPUELA"){ ?>
          ...
          <div class="form-group">
              ...
              <div class="form-group" <?php echo $esconder_div; ?>>
                <label for="precio_tonelada" class="col-sm-2 control-label">Precio Tonelada</label>
                <div class="col-sm-4">
					<input name="precio_tonelada" type="text" readonly required class="form-control peso_monto" id="precio_tonelada" value="">                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
					<input type="text" name="nombre_flete" class="form-control" id="nombre_flete" required value="">                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
					<input type="text" name="entrada_flete" class="form-control" id="entrada_flete" required>                
                </div>
...
?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                <?php if($depto == "MINA" && $puesto == "ESPUELA") { ?>
                    <input type="text" name="peso_final" class="form-control peso_monto" id="peso_final" required>
                    <input type="hidden" name="toneladas_remision" class="form-control peso_monto" id="toneladas_remision" >
                <?php } else { ?>
				...
				<?php if($depto == "MINA" && $puesto == "ESPUELA") { //SI ES ESPUELA NO HAGAS NADA ?>
                <? } else { ?>
              <div class="form-group">
