...
<div id="invoice">
    ...
    <div class="invoice " id="printableArea">
      ...
      <div class="row">
        <div class="col-xs-6">
        <?php if($all_remisiones_complete_id['id_registro_patronal']==1) {?>
        <img src="<?= base_url() ?>public/dist/img/regiocal-oficial.png" style="width:150px;" alt="logo-mymisa">
        <?php } else { ?>
        <img src="<?= base_url() ?>public/dist/img/mymisa.jpg" style="width:150px" alt="logo-regiocal">
        <?php } ?>
        </div>
        <div class="col-xs-6">
        <tr>
        ...
        <td height="20px">No. REMISION </td><td height="20px"><strong><?=  $all_remisiones_complete_id['id_serie'] ?></strong></td>
            ...
            <main>
                ...
                <td align="center" width="32%"><strong>MATERIAL</strong></td>
                <td align="center" width="32%"><strong>Unidad</strong></td>
                <td align="center" width="32%"><strong>Cantidad</strong></td>
                </tr>
                <tr>
                ...
                <br>
                Observaciones:
                <textarea readonly name="notas_remision" class="form-control" id="notas_remision" style="resize: none;
                border:none; background-color: #fff;"><?= $all_remisiones_complete_id['notas_remision']; ?></textarea>
            </main>
        </div>
        <!--NO BORRAR ESTE DIV-->
        <!-- <div></div> -->
