			...
			<?php echo form_open(base_url('admin/remisiones/edit/'.$all_remisiones_complete_id['id']), 'class="form-horizontal"' )?>    
              ...
              <div class="form-group">
               ...
               <select name="id_pedido" id="id_pedido" class="form-control select2" required onchange="get_values();">
                  <?php if($all_remisiones_complete_id['id_pedido']==0) { ?>
                  <option value="0">000 - Sin Pedido</option>
                  <?php } else { ?>
                  <?php foreach($all_pedidos_complete as $row): 
				  $selected="";
                  if($row['id']==$all_remisiones_complete_id['id_pedido']) {$selected="selected";} 
				  ?>
                    <option value="<?= $row['id'];?>" <?=$selected; ?>><?= $row['id']; ?> - <?= $row['razon_social']; ?></option>
                    <?php endforeach;
                     } ?>
                  </select>
                  </div>
                ...
                <div class="col-sm-5">
				  ...
				  $selected="";
                  if($row['id']==$all_remisiones_complete_id['id_registro_patronal']) {$selected="selected";} 
				  ?>
          ...
          <input type="text" name="razon_social" class="form-control" id="razon_social"  value="<?php echo $all_remisiones_complete_id['razon_social']; ?>" readonly> 
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="id_material" id="id_material" value="<?php echo $all_remisiones_complete_id['id_material']; ?>">
                  <input type="text" name="nombre_del_material" id="nombre_del_material"  class="form-control"  value="<?php echo $all_remisiones_complete_id['nombre_del_material']; ?>" readonly> 
 ...
 */							
							...
							$('#nombre_del_material').val(data['nombre_del_material']);
							$('#nombre_del_material').attr('readonly', true); 
