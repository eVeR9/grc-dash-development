        ...
        <div class="box-body ">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/remisiones/edit/'), 'class="form-horizontal"' )?>            
                ...
                <label for="fecha_remision" class="col-sm-2 control-label bold">Fecha Creación:</label>
                <div class="col-sm-4">
                  <label for="" class="control-label"><?= $all_remisiones_complete_id['fecha_remision']; ?></label>
                  </div>

                <label for="estatus_pedido" class="col-sm-2 control-label bold">Fase Remisión:</label>

                <div class="col-sm-4">
                <!-- <select name="id_fase_de_remision" id="id_fase_de_remision" class="form-control">
                    <option value="">Selecciona Fase</option> -->
                     <label for="" name="fase_de_remision" class="control-label"><?= $all_remisiones_complete_id['fase_de_remision']; ?></label>
                ...
                <label for="serie" class="col-sm-2 control-label bold">Serie:</label>
                <div class="col-sm-4">
                <label for="" name="serie" class="control-label"><?= $all_remisiones_complete_id['serie']; ?></label>
                ...
                <label for="id_serie" class="col-sm-2 control-label bold">Folio:</label>
                <div class="col-sm-4">
                <label for="" name="id_serie" class="control-label"><?= $all_remisiones_complete_id['id_serie']; ?></label>
                </div>
                </div>
                ...
                <label for="id_pedido" class="col-sm-1 control-label bold">Pedido:</label>

                <div class="col-sm-5">
                <input type="hidden" name="id_pedido" class="form-control" id="id_pedido" value="<?php echo $all_remisiones_complete_id['id_pedido'];?>" >
                <label for="" class="control-label" name="id_pedido2"><?php if(!empty($all_remisiones_complete_id['id_pedido'])) { echo $all_remisiones_complete_id['id_pedido'] .' - '.$all_remisiones_complete_id['razon_social'];} else echo 'Sin pedido'; ?></label>
                <!-- <input type="text" name="id_pedido2" class="form-control" id="id_pedido2" value=""> -->
                </div>

                <label for="razon_social_remisiona" class="col-sm-1 control-label bold">Remisiona:</label>
                <div class="col-sm-5">
                  ...
                  <label for="" name="registro_patronal_re" class="control-label"><?php echo $all_remisiones_complete_id['razon_social_re'] ?></label>
                  <!-- <input type="text" name="registro_patronal_re" class="form-control" id="registro_patronal_re" value=""> -->
                </div>
              </div>

          <div class="form-group">
                <label for="razon_social" class="col-sm-1 control-label bold">Cliente:</label>
                <div class="col-sm-5">
                <input type="hidden" name="id_cliente" id="id_cliente" value="<?php echo $all_remisiones_complete_id['id_cliente'] ?>">
                <label for="" name="razon_social" class="control-label"><?php echo $all_remisiones_complete_id['razon_social']; ?></label>
                <!-- <input type="text" name="razon_social" class="form-control" id="razon_social"  value=""> -->
                </div>

                <label for="orden_de_compra" class="col-sm-2 control-label bold">Orden de Compra:</label>
                <div class="col-sm-4">
                <label for="" name="orden_de_compra" class="control-label"><?php if(!empty($all_remisiones_complete_id['id_pedido'])) { echo $all_remisiones_complete_id['orden_de_compra']; } else { echo $all_remisiones_complete_id['orden_de_compra_remision']; } ?></label>
					      <!-- <input type="text" name="orden_de_compra" id="orden_de_compra" class="form-control" value=""> -->
                </div>
              </div>

              <div class="form-group">
                <label for="sucursal" class="col-sm-1 control-label bold">Sucursal:</label>
                <div class="col-sm-5">
                <input type="hidden" name="id_sucursal" id="id_sucursal" value="<?php echo $all_remisiones_complete_id['id_sucursal']; ?>">
                <label for="" name="sucursal" class="control-label"><?php echo $all_remisiones_complete_id['sucursal']; ?></label>
                <!-- <input name="sucursal" type="text"  class="form-control" id="sucursal" value=""> -->                
                </div>

                <label for="obra_cliente" class="col-sm-2 control-label bold">Obra de Cliente:</label>
                <div class="col-sm-4">
                <label for="" name="obra_cliente" class="control-label"><?php echo $all_remisiones_complete_id['obra_cliente']; ?></label>
					      <!-- <input type="text" name="obra_cliente" id="obra_cliente" class="form-control"  value=""> -->                
            </div>
              ...
              <div class="form-group">
                <label for="vendedor" class="col-sm-1 control-label bold">Vendedor:</label>
                <div class="col-sm-5">
                    <input type="hidden" name="id_vendedor" id="id_vendedor" value="<?php echo $all_remisiones_complete_id['id_vendedor']; ?>">     
                    <label for="" name="vendedor" class="control-label"><?php echo $all_remisiones_complete_id['nombre_vendedor']; ?></label>      
                    <!-- <input type="text" name="vendedor" id="vendedor" class="form-control" value=""> -->     
                </div>

                <label for="nombre_del_material" class="col-sm-2 control-label bold">Material:</label>
                <div class="col-sm-4">
               <!--
                ...
                <label for="" name="nombre_del_material" class="control-label"><?= $all_remisiones_complete_id['nombre_del_material'] ?></label>
              ...
              <div class="form-group">
                <label for="notas" class="col-sm-2 control-label bold">Comentarios Pedido:</label>
                <div class="col-sm-10">
                <label for="" name="notas" class="control-label"><?php echo $all_remisiones_complete_id['notas']; ?></label>
...
<div class="green box">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					        <label class="control-label"><?= $all_remisiones_complete_id['peso_final'] - $all_remisiones_complete_id['peso_inicial']; ?></label>                
                </div>
