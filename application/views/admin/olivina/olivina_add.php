        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Consumo Olivina</h3>
                </div>
                <div class="box-body my-form-body">
                    <?php if (isset($msg) || validation_errors() !== '') : ?>
                        <div clas="alert alert-warning alert-dismissible">
                    ...
                    <?php endif; ?>
                    <?php echo form_open(base_url('admin/olivina/add'), 'class="form-horizontal"'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="number" step="any" name="lectura_inicial" class="form-control" id="lectura_inicial"  required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="number" step="any" name="lectura_final" class="form-control" id="lectura_final"  onKeyUp="fncRest()"  required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="number"  step="any" name="consumo_gas" class="form-control" id="consumo_gas" min="0"   readonly required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="number" step="any" name="gigajoules" class="form-control" id="gigajoules"  required>
                        </div>
                    </div>
