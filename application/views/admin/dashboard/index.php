...
<?php $user = strtoupper($this->session->userdata('id_usuario')); ?>
...
<?php if($depto == 'TI' || $user == 6 || $user == 4) { ?>
<iframe frameborder=0 width="1024" height="768" src="https://analytics.zoho.com/open-view/1749734000011458191"></iframe>
<?php }?> 
