        ...
        <div class="box">
            ...
            <div class="form-group">
                <label for="" class="col-md-2 control-label">Zona:</label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" name="zona" id="zona" style="width:180px;">
                  </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="number" class="form-control" min="0" step="any" placeholder="Numero de barreno" name="bar_perf" id="bar_perf" style="width:180px;" required>
                </div>
...
public function get_empleados_barrenacion(){
        ...
        $this->db->having('fecha_de_baja = 0');
