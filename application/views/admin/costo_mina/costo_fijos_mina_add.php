        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body my-form-body">
                    ...
                    <?php echo form_open(base_url('admin/costo_mina/costo_fijos_mina_add'), 'class="form-horizontal"');  ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="number" step="any" name="monto_arrendamiento_diario" class="form-control" id="total" readonly  required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="number" step="any" name="monto_cfe_diario" class="form-control" id="total1" readonly required>
                        </div>
                    </div>
