        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Costos de Mina</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    ...
                    <?php echo form_open(base_url('admin/costo_mina/costo_diario_mina_add'), 'class="form-horizontal"');  ?>
                ...
                <div style="display:none;">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Gastos Fijos</h3>
                    </div>
                    <br>
                    
                    <div class="form-group">

                        <label for="pxc" class="col-sm-2 control-label">Arrendamiento</label>
                        ...
                        <label for="pxc" class="col-sm-2 control-label">CFE</label>
                    ...
                    <div class="form-group">
                        ...
                        <label for="" class="col-sm-2 control-label">Toneladas</label>
...
if(id != 0){
    //checamos fecha, si existe no procede el insert
    $.ajax({
        url: "<?= base_url()?>admin/costo_mina/CheckNominaFecha/"+id,
        method: 'POST',
        data: {id:id},
        async: true,
        dataType: 'json',
    ...
    $.ajax({
        url: "<?= base_url()?>admin/costo_mina/getTotalCostoDiario/"+id,
        method: 'POST',
        data: {id:id},
        async: true,
        dataType: 'json',
    ...
    $.ajax({
        url: "<?= base_url()?>admin/costo_mina/get_total_produccion/"+id,
        method: 'POST',
        data: {id:id},
        async: true,
        dataType: 'json',
