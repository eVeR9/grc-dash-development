        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h1 class="box-title">Captura Consumo Gas Hornos</h1>
                </div>
                ...
                <div class="box-body">
                    ...
                    <?php echo form_open(base_url('admin/hornos/hornos_consumo_gas'), 'class="form-horizontal"') ?>
...
<script>
    ...
    $("#fecha").on("change", function() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>admin/hornos/getCalculoEnergiaGeneral/" + fecha,
            ...
            //dataType: 'json',
            error: function(data) {
                alert('No se pudo enlazar en la API');
            },
