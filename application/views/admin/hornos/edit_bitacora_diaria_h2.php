        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h1 class="box-title">Editar Bitacora Diaria Horno 2</h1>
                </div>
                ...
                <div class="box-body">
                    ...
                    <?php echo form_open(base_url('admin/hornos/edit_bitacora_diaria_h2/' . $bitacora['id']), 'class="form-horizontal"') ?>
                    ...
                    <div id="body-h1-h2">
                        ...
                        <div id="temp-horno-1">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" step="any" min="0" name="temperatura_norte" class="form-control" id="temperatura_norte" value="<?= $bitacora['temperatura_norte']; ?>">
                                </div>

                                <label for="temperatura_sur" class="col-sm-1 control-label">Sur</label>
                                <div class="col-sm-5">
                                    <input type="number" step="any" min="0" name="temperatura_sur" class="form-control" id="temperatura_sur" value="<?= $bitacora['temperatura_sur']; ?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="any" min="0" name="temperatura_promedio" class="form-control" id="temperatura_promedio" value="<?= $bitacora['temperatura_promedio']; ?>">
                                </div>

                                <label for="temperatura_diferencia" class="col-sm-1 control-label">Diferencia</label>
                                <div class="col-sm-3">
                                    <input type="number" step="any" name="temperatura_diferencia" class="form-control" id="temperatura_diferencia" value="<?= $bitacora['temperatura_diferencia']; ?>">
                                </div>

                                <label for="temperatura_mesa" class="col-sm-1 control-label">Mesa</label>
                                <div class="col-sm-3">
                                    <input type="number" step="any" min="0" name="temperatura_mesa" class="form-control" id="temperatura_mesa" value="<?= $bitacora['temperatura_mesa']; ?>">
                                </div>
