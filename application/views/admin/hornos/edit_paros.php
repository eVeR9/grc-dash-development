        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h1 class="box-title">Editar Captura de Paros</h1>
                </div>
                ...
                <div class="box-body">
                    ...
                    <?php echo form_open(base_url('admin/hornos/edit_paros/' . $editParos['id']), 'class="form-horizontal"'); ?>

                    <div class="form-group">

                        <label for="fecha" class="col-sm-1 control-label">Fecha</label>
                        <div class="col-sm-3">
                            <input type="text" name="fecha" id="fecha" value="<?= $editParos['fecha']; ?>" class="form-control datepick" autocomplete="off">
                        </div>

                        <label for="tiempo" class="col-sm-1 control-label">Tiempo</label>
                        <div class="col-sm-2">
                            <input type="number" min="0" step="0.01" name="tiempo" id="tiempo" value="<?= $editParos['tiempo']; ?>" class="form-control tiempo">
                        </div>

                        <label for="horno_id" class="col-sm-1 control-label">Horno</label>
                        <div class="col-sm-4">
                            <select name="horno_id" class="form-control">
                                <?php if ($editParos['horno_id'] == '1') : ?>
                                    <option value="1" selected>Horno 1</option>
                                    <option value="2">Horno 2</option>
                                    <option value="3">Horno 3</option>
                                <?php elseif ($editParos['horno_id'] == '2') : ?>
                                    <option value="1">Horno 1</option>
                                    <option value="2" selected>Horno 2</option>
                                    <option value="3">Horno 3</option>
                                <?php else : ?>
                                    <option value="1">Horno 1</option>
                                    <option value="2">Horno 2</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <?php foreach ($motivos as $row) : ?>
                                    ...
                                    //$selected = ('id');
                                    $selected = "";
                                    if ($row['id'] == $editParos['motivo_paro_id']) {
                                        $selected = "selected";
                                    }
                                    ?>
                                    <option value="<?= $row['id'] ?>" <?= $selected; ?>><?= $row['motivo'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-5">
                            <select name="equipo_paro_id" id="equipo_paro_id" value="<?= $editParos['equipo_paro_id']; ?>" class="form-control select-hornos">
                                ...
                                <?php foreach ($equipos as $row) : ?>
                                    ...
                                    //$selected = ('id');
                                    $selected = "";
                                    if ($row['id'] == $editParos['equipo_paro_id']) {
                                        $selected = "selected";
                                    }
                                    ?>
                                    <option value="<?= $row['id'] ?>" <?= $selected; ?>><?= $row['equipo'] ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="datetime" name="hora_inicio" id="hora_inicio" value="<?= $editParos['hora_inicio']; ?>" class="form-control">
                        </div>

                        <label for="hora_final" class="col-sm-1 control-label">Hora Final</label>
                        <div class="col-sm-3">
                            <input type="datetime-local" name="hora_final" id="hora_final" value="<?= $editParos['hora_final']; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea class="form-control" name="comentarios"  name="comentarios" id="comentarios"> <?php echo $editParos['comentarios'];?> </textarea>
                        </div>

                        <label for="atribuido_a" class="col-sm-1 control-label">Atribuible a:</label>
                        <div class="col-sm-3">
                            <input type="text" name="atribuido_a" id="atribuido_a" value="<?= $editParos['atribuido_a']; ?>" class="form-control">
                        </div>
