            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="toneladas" class="col-sm-1 control-label">Factor</label>
                        <div class="col-sm-3">
                            <input type="number" step="any" min="0" name="factor" id="factor" class="form-control">
                        </div>

                        <label for="toneladas" class="col-sm-1 control-label">Toneladas</label>
                        <div class="col-sm-3">
                            <input type="number" step="any" min="0" name="toneladas" id="toneladas" class="form-control" readonly>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#factor').keyup(function(){
            ...
            let factor = Number($(this).val())
            let sacos = Number($('#cantidad_sacos').val())
            let toneladas = factor*sacos
