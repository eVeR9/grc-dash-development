          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/users/edit/'.$user['id']), 'class="form-horizontal"' )?> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="apellidos" value="<?= $user['apellidos']; ?>" class="form-control" id="apellidos" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="password" name="password" class="form-control" id="password" placeholder="En caso de querer cambiar password">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="activo" class="form-control">
                    ...
                    <option value="1" <?= ($user['activo'] == 1)?'selected': '' ?> >Si</option>
