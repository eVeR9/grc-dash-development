        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body my-form-body">
                    ...
                    <?php echo form_open(base_url('admin/linea_gas/gas_precio_mensual_add'), 'class="form-horizontal"');  ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="any" name="precio" class="form-control" id="precio" required>
                        </div>
                    </div>
