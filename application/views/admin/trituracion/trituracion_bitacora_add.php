            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula2" id="b2" class="form-control bascula" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula3" id="b3" class="form-control bascula" readonly>
                        </div>
                    </div>
...
return $('#total_toneladas_producidas').val(sum);
    ...
    $('#fecha').on('change', function() {
        ...
        if (id != '') { //trigger
            $.ajax({
                url: "<?php echo base_url(); ?>admin/trituracion/getBasculas/" + id,
                method: 'POST',
                data: {
                    id: id
                },
                ...
                success: function(data) {
                    ...
                    $('#b1').val(data['b1_total']);
                    $('#b2').val(data['b2_total']);
                    $('#b3').val(data['b3_total']);
                    $('#total_toneladas_producidas').val(data['b4_total']);
                    //alert(data);
                    //alert(data['b1_total']);
