    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Agregar Meta Mensual de Embarque</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/metas_embarques/add'), 'class="form-horizontal"');  ?> 
            <?php
				$mes = date("m");
				$mes = (int)str_pad($mes, 2, "0", STR_PAD_LEFT);
				//echo $mes;
				$anio = date("Y");
				$prev_anio = $anio - 1;
			?>
...
<!-- displaying the dropdown list -->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="id_sucursal" id="id_sucursal" class="form-control" required disabled>
                ...
                <div class="col-sm-4">
                <input type="text" name="obra_cliente" class="form-control" id="obra_cliente" placeholder="">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="any" name="toneladas" class="form-control calcular" id="toneladas" value="toneladas" placeholder="" required>
                </div>
                
                <label for="dias_habiles" class="col-sm-2 control-label">Días Hábiles</label>
                <div class="col-sm-4">
                    <input type="number" step="0.01" name="dias_habiles" class="form-control calcular" id="dias_habiles" values="dias_habiles" min="1.00" max="31.00" placeholder="" required>
                </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="any" name="meta_diaria" class="form-control calcular" id="meta_diaria" value="meta_diaria" placeholder="" required readonly>
                </div>
                
                <label for="meta_semanal" class="col-sm-2 control-label">Meta Semanal</label>
                <div class="col-sm-4">
                    <input type="any" name="meta_semanal" class="form-control calcular" id="meta_semanal" value="meta_semanal" placeholder="" required readonly>
                </div>
                </div>

              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Agregar Meta" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
...
jQuery('body').on('input','input.calcular',function(){
     ...
     meta_diaria = parseFloat($('#meta_diaria').val());
       meta_semanal = meta_diaria * 7 ; 
       meta_semanal = parseFloat($('#meta_semanal').val());
       // toneladas / 4.345 dato(Jonathan)
