...
?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                <input type="text" name="obra_cliente" class="form-control" id="obra_cliente" value="<?php echo $me_id['obra_cliente']; ?>">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="any" name="meta_diaria" class="form-control" id="meta_diaria" placeholder="" required value="<?php echo $me_id['meta_diaria']; ?>">
                </div>
