            ...
            <div class="box">
                ...
                <div class="box-body my-form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="any" min="0" name="cao" class="form-control" id="cao" required>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="any" min="0" name="mgo" class="form-control" id="mgo" required>
                        </div>
