...
<div class="green box">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="toneladas_remision" class="form-control peso_monto" id="toneladas_remision" value="<?= $all_remisiones_complete_id['toneladas_remision']; ?>" required style="margin-bottom:10px;">                
                </div>
