...
<?php
    $id_serie=0;
    if($remision_espera_id['serie']=='A'){ $id_serie=$next_id_a;}
    if($remision_espera_id['serie']=='E'){ $id_serie=$next_id_e;}
    if($remision_espera_id['serie']=='G'){ $id_serie=$next_id_g;}
?>
    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Agregar Remision</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body ">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
			...
			<?php echo form_open(base_url('admin/remisiones/add_remision_espera/'.$remision_espera_id['id']), 'class="form-horizontal"' )?>    
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="fecha_remision" class="form-control" required value="<?= $remision_espera_id['fecha_espera']; ?>" readonly>
                  </div>
                  </div>
                <label for="estatus_pedido" class="col-sm-2 control-label">Fase Remisión</label>

                <div class="col-sm-4">
                  <input type="hidden" name="id_fase_de_remision" class="form-control" id="id_fase_de_remision" value="2" >
                  <input type="text" name="id_fase_de_remision2" class="form-control" id="id_fase_de_remision2" value="Cargada" readonly>
                </div>
                </div>
                ...
                <div class="col-sm-4">
                <input type="text" name="id_serie" class="form-control" id="id_serie" value="<?= $remision_espera_id['serie']; ?>" readonly>
                ...
                <div class="col-sm-4">
					<input type="text" name="id_serie" class="form-control" id="id_serie" value="<?= $id_serie; ?>" readonly>
                </div>
                </div>
                ...
                <div class="col-sm-5">
                <input type="hidden" name="id_pedido" class="form-control" id="id_pedido" value="<?php echo $remision_espera_id['id_pedido'];?>" >

                <input type="text" name="id_pedido2" class="form-control" id="id_pedido2" value="<?php if(!empty($remision_espera_id['id_pedido'])) { echo $remision_espera_id['id_pedido'] .' - '.$remision_espera_id['razon_social'];} else echo 'Sin pedido'; ?>" readonly>
                </div>
                <label for="razon_social_remisiona" class="col-sm-1 control-label">Remisiona:</label>
                <div class="col-sm-5">
                  <input type="hidden" name="id_registro_patronal" id="id_registro_patronal" value="<?php echo $remision_espera_id['id_registro_patronal'] ?>">
                  <input type="text" name="registro_patronal_re" class="form-control" id="registro_patronal_re" value="<?php echo $remision_espera_id['razon_social_re'] ?>" readonly>
                </div>
              </div>
          ...
          <div class="form-group">
                ...
                <div class="col-sm-5">
                <input type="hidden" name="id_folio_espera" id="id_folio_espera" value="<?php echo $remision_espera_id['id_folio_espera'] ?>">
                <input type="hidden" name="id_cliente" id="id_cliente" value="<?php echo $remision_espera_id['id_cliente'] ?>">
          <input type="text" name="razon_social" class="form-control" id="razon_social"  value="<?php echo $remision_espera_id['razon_social']; ?>" readonly> 
                </div>

                <label for="orden_de_compra" class="col-sm-2 control-label">Orden de Compra:</label>
                <div class="col-sm-4">
					<input type="text" name="orden_de_compra" id="orden_de_compra" class="form-control" value="<?php if(!empty($remision_espera_id['id_pedido'])) { echo $remision_espera_id['orden_de_compra']; } else { echo $remision_espera_id['orden_de_compra_remision']; } ?>" readonly>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                <input type="hidden" name="id_sucursal" id="id_sucursal" value="<?php echo $remision_espera_id['id_suc']; ?>">
                <input name="sucursal" type="text"  class="form-control" id="sucursal" value="<?php echo $remision_espera_id['nombre_sucursal']; ?>" readonly>                
                </div>

                <label for="obra_cliente" class="col-sm-2 control-label">Obra de Cliente:</label>
                <div class="col-sm-4">
					<input type="text" name="obra_cliente" id="obra_cliente" class="form-control"  
            value="<?php 
                      if(!empty($remision_espera_id['id_pedido'])){ 
                          echo $remision_espera_id['obra_cliente'];
                        } else{ 
                            echo $remision_espera_id['obra_cliente_remision'];
                          }
                   ?>" readonly >                
            </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="hidden" name="id_vendedor" id="id_vendedor" value="<?php echo $remision_espera_id['id_vendedor']; ?>">
                    <input type="text" name="vendedor" id="vendedor" class="form-control" value="<?php echo $remision_espera_id['nombre_vendedor'];  ?>" readonly>                
                </div>

                <label for="nombre_del_material" class="col-sm-2 control-label">Material:</label>
                <div class="col-sm-4">
                  <input type="hidden" name="id_material" id="id_material" value="<?php echo $remision_espera_id['id_material']; ?>">
                  <input type="text" name="nombre_del_material" id="nombre_del_material"  class="form-control"  value="<?php echo $remision_espera_id['nombre_del_material']; ?>" readonly> 
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                <textarea name="notas" id="notas" class="form-control" readonly><?php echo $remision_espera_id['notas']; ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" class="form-control peso_monto" name="precio_tonelada" id="precio_tonelada" value="<?php echo $remision_espera_id['precio_tonelada']; ?>" readonly>                
                </div>
                <label for="monto_total" class="col-sm-2 control-label">Monto Total</label>

                <div class="col-sm-4">
					<input type="text" name="monto_total_pedido" class="form-control peso_monto" id="monto_total_pedido" value="<?php echo $remision_espera_id['monto_total']; ?>" readonly>                
                </div>
              </div>
               <?php } else { ?>
                <input type="hidden" class="form-control peso_monto" name="precio_tonelada" id="precio_tonelada" value="<?php echo $remision_espera_id['precio_tonelada']; ?>" >                
                <input type="hidden" name="monto_total_pedido" class="form-control peso_monto" id="monto_total_pedido" value="<?php echo $remision_espera_id['monto_total']; ?>" >                
               <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
					<input type="text" name="toneladas_pedido" class="form-control" id="toneladas_pedido" value="<?php echo $remision_espera_id['toneladas']; ?>" readonly>                
                </div>
 
                 <label for="toneladas_embarcadas" class="col-sm-2 control-label">Toneladas Embarcadas</label>

                <div class="col-sm-2">
					<input type="text" name="toneladas_embarcadas" class="form-control" id="toneladas_embarcadas" value="<?php echo $remision_espera_id['toneladas_embarcadas']; ?>" readonly>                
                </div>

                
                <label for="toneladas_restantes" class="col-sm-2 control-label">Toneladas Restantes</label>
                <div class="col-sm-2">
					<input type="text" name="toneladas_restantes" class="form-control" id="toneladas_restantes" value="<?php echo ($remision_espera_id['toneladas'] - $remision_espera_id['toneladas_embarcadas']); ?>" readonly>               
                </div>
				</div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
					<input type="text" name="nombre_flete" class="form-control" id="nombre_flete" value="<?= $remision_espera_id['nombre_flete']; ?>" readonly >                
                </div>
                
                <label for="flete_operador" class="col-sm-1 control-label">Operador</label>
                <div class="col-sm-3">
					<input type="text" name="nombre_operador_flete" class="form-control" id="nombre_operador_flete" value="<?= $remision_espera_id['nombre_operador_flete']; ?>" readonly>                
                </div>
                
                <label for="flete_placas" class="col-sm-1 control-label">Placas</label>
                <div class="col-sm-3">
					<input type="text" name="placas_flete" class="form-control" id="placas_flete" value="<?= $remision_espera_id['placas_flete']; ?>"  readonly>                
                </div>

				</div>

              <div class="form-group">
                <label for="entrada" class="col-sm-1 control-label">Entrada Bascula</label>
                <div class="col-sm-3">
				          <input type="text" name="entrada_flete" class="form-control" id="entrada_flete"value="<?php echo date('Y-m-d - h:i:s'); ?>" readonly >                
                </div>

                <label for="salida" class="col-sm-1 control-label">Salida Bascula</label>
                <div class="col-sm-3">
					<input type="text" name="salida_flete" class="form-control" id="salida_flete" value="---" disabled>                
                </div>

                <label for="" class="col-sm-1 control-label">Venta Directa</label>
                <div class="col-sm-3 aline-div">
                    No&nbsp;&nbsp;<input type="radio" name="venta_directa" class="" 
                    value="<?php 
                           $checked=""; if($remision_espera_id['venta_directa'] == 0) { 
                                $checked = "checked";
                                }
                          ?>"
                    <?= $checked; ?> disabled>&nbsp;
                    Si&nbsp;&nbsp;<input type="radio" name="venta_directa" class="" 
                    value="<?php 
                          $checked=""; if($remision_espera_id['venta_directa'] == 1) {
                               $checked = "checked";
                                } 
                          ?>"
                    <?= $checked;?> disabled>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
					<input type="text" name="destino_flete" class="form-control" id="destino_flete" value="<?= $remision_espera_id['destino_flete']; ?>" readonly >                
                </div>
                <!--
                <label for="cajas" class="col-sm-1 control-label">Cajas</label>
                <div class="col-sm-3">
					<input type="text" name="cajas_flete" class="form-control" id="cajas_flete" value="<?= $remision_espera_id['cajas_flete'] ?>" >                
                </div>
                -->
                <label for="cargado-interno" class="col-sm-2 control-label">Folio cargado ext.</label>
                  <div class="col-sm-2">
                    <input type="text" name="cargado_externo" class="form-control" id="cargado_externo" readonly>
                  </div>

                <label for="tipo_flete" class="col-sm-1 control-label">Full/Sencillo</label>
                <div class="col-sm-3">
                  <input type="text" name="tipo_flete" class="form-control" id="tipo_flete" value="<?= $remision_espera_id['tipo_flete']; ?>" readonly>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                	<textarea name="notas_remision" class="form-control" id="notas_remision" value="<?= $remision_espera_id['notas_remision']; ?>"  readonly></textarea>
                </div>
              </div>
...
?>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Crear Remision" class="btn btn-info pull-right">
                  <input type="button" name="back" value="Cancelar" class="btn btn-danger pull-left" onClick="history.go(-1)"
                  style="width:105px;">
                </div>
              </div>
            <?php echo form_close(); ?> 
