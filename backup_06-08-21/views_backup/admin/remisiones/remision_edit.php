    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Editar Remisión | Admin - Remision: <?= $all_remisiones_complete_id['id_serie']?></h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body ">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
			...
			<?php echo form_open(base_url('admin/remisiones/edit/'.$all_remisiones_complete_id['id']), 'class="form-horizontal"' )?>    
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="id_fase_de_remision" id="id_fase_de_remision" class="form-control">
                ...
                <div class="col-sm-4">
                <input type="text" name="id_serie" class="form-control" id="id_serie" value="<?= $all_remisiones_complete_id['serie']; ?>" readonly>
                ...
                <div class="col-sm-4">
					<input type="text" name="id_serie" class="form-control" id="id_serie" value="<?= $all_remisiones_complete_id['id_serie']; ?>" readonly>
                </div>
                </div>
                ...
                <input type="text" name="id_pedido2" class="form-control" id="id_pedido2" value="<?php if(!empty($all_remisiones_complete_id['id_pedido'])) { echo $all_remisiones_complete_id['id_pedido'] .' - '.$all_remisiones_complete_id['razon_social'];} else echo 'Sin pedido'; ?>" readonly>
                </div>
                ...
                <div class="col-sm-5">
                  ...
                  <input type="text" name="registro_patronal_re" class="form-control" id="registro_patronal_re" value="<?php echo $all_remisiones_complete_id['razon_social_re'] ?>" readonly>
                </div>
              </div>
          ...
          <input type="text" name="razon_social" class="form-control" id="razon_social"  value="<?php echo $all_remisiones_complete_id['razon_social']; ?>" readonly > 
                ...
                <div class="col-sm-4">
					<input type="text" name="orden_de_compra" id="orden_de_compra" class="form-control" value="<?php if(!empty($all_remisiones_complete_id['id_pedido'])) { echo $all_remisiones_complete_id['orden_de_compra']; } else { echo $all_remisiones_complete_id['orden_de_compra_remision']; } ?>" readonly>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                <input type="hidden" name="id_sucursal" id="id_sucursal" value="<?php echo $all_remisiones_complete_id['id_sucursal']; ?>">
                <input name="sucursal" type="text"  class="form-control" id="sucursal" value="<?php echo $all_remisiones_complete_id['sucursal']; ?>" readonly>                
                </div>

                <label for="obra_cliente" class="col-sm-2 control-label">Obra de Cliente:</label>
                <div class="col-sm-4">
                <?php if(!empty($all_remisiones_complete_id['id_pedido'])) { ?>
					                <input type="text" name="obra_cliente" id="obra_cliente" class="form-control" value="<?php echo $all_remisiones_complete_id['obra_cliente']; ?>" readonly >
                      <?php } else { ?>
					                <input type="text" name="obra_cliente" id="obra_cliente" class="form-control" value="<?php echo $all_remisiones_complete_id['obra_cliente_remision']; ?>" readonly >
                      <?php } ?>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <input type="text" name="vendedor" id="vendedor" class="form-control" value="<?php echo $all_remisiones_complete_id['nombre_vendedor'];  ?>" readonly>                
                </div>
               ...
               <!--
                <input type="hidden" name="id_material" id="id_material" value="<?php //echo $all_remisiones_complete_id['id_material']; ?>">
                  <input type="text" name="nombre_del_material" id="nombre_del_material"  class="form-control"  value="<?php //echo $all_remisiones_complete_id['nombre_del_material']; ?>" > 
                ...
                <input type="hidden" name="id_material" id="id_material" value="<?php echo $all_remisiones_complete_id['id_material']; ?>">
                  ...
                  <?php
                    if($row['id']==$all_remisiones_complete_id['id_material'])
                      {
                    ?>
                    <input type="text" name="nombre_del_material"  class="form-control" id="nombre_del_material" value="<?= $row['nombre_del_material']; ?>" readonly>
                    <?php
                    }
				            ?>
                    <?php endforeach; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" class="form-control peso_monto" name="precio_tonelada" id="precio_tonelada" value="<?php echo $all_remisiones_complete_id['precio_tonelada']; ?>" readonly >                
                </div>
                <label for="monto_total" class="col-sm-2 control-label">Monto Total</label>

                <div class="col-sm-4">
					<input type="text" name="monto_total_pedido" class="form-control peso_monto" id="monto_total_pedido" value="<?php echo $all_remisiones_complete_id['monto_total']; ?>" readonly>                
                </div>
              </div>
               <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
					<input type="text" name="toneladas_pedido" class="form-control" id="toneladas_pedido" value="<?php echo $all_remisiones_complete_id['toneladas']; ?>" readonly>                
                </div>
 
                 <label for="toneladas_embarcadas" class="col-sm-2 control-label">Toneladas Embarcadas</label>

                <div class="col-sm-2">
					<input type="text" name="toneladas_embarcadas" class="form-control" id="toneladas_embarcadas" value="<?php echo $all_remisiones_complete_id['toneladas_embarcadas']; ?>" readonly>                
                </div>

                
                <label for="toneladas_restantes" class="col-sm-2 control-label">Toneladas Restantes</label>
                <div class="col-sm-2">
					<input type="text" name="toneladas_restantes" class="form-control" id="toneladas_restantes" value="<?php echo ($all_remisiones_complete_id['toneladas'] - $all_remisiones_complete_id['toneladas_embarcadas']); ?>" readonly>               
                </div>
				</div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
					<input type="text" name="nombre_flete" class="form-control" id="nombre_flete" value="<?= $all_remisiones_complete_id['nombre_flete']; ?>" readonly>                
                </div>
                
                <label for="flete_operador" class="col-sm-1 control-label">Operador</label>
                <div class="col-sm-3">
					<input type="text" name="nombre_operador_flete" class="form-control" id="nombre_operador_flete" value="<?= $all_remisiones_complete_id['nombre_operador_flete']; ?>" readonly>                
                </div>
                
                <label for="flete_placas" class="col-sm-1 control-label">Placas</label>
                <div class="col-sm-3">
					<input type="text" name="placas_flete" class="form-control" id="placas_flete" value="<?= $all_remisiones_complete_id['placas_flete']; ?>"  readonly>                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="entrada_flete" class="form-control" id="entrada_flete" value="<?= $all_remisiones_complete_id['entrada_flete']; ?>" readonly>                
                </div>
                ...
                <?php if($all_remisiones_complete_id['salida_flete']=='0000-00-00 00:00:00'){ ?>
                        <input type="datetime" name="salida_flete" class="form-control" id="salida_flete" value="<?php echo date('Y-m-d - h:i:s'); ?>"> 
                <?php } else { ?>
                        <input type="datetime" name="salida_flete" class="form-control" id="salida_flete" value="<?= $all_remisiones_complete_id['salida_flete']; ?>" readonly>
                <?php } ?>  
                </div>
                </div>
                ...
                <div class="col-sm-3 aline-div">
                    ...
                    value="<?php 
                           $checked=""; if($all_remisiones_complete_id['venta_directa'] == 0) { 
                                $checked = "checked";
                                }
                          ?>"
                    <?= $checked; ?> disabled>&nbsp;
                    ...
                    value="<?php 
                          $checked=""; if($all_remisiones_complete_id['venta_directa'] == 1) {
                               $checked = "checked";
                                } 
                          ?>"
                    <?= $checked;?> disabled>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
					<input type="text" name="destino_flete" class="form-control" id="destino_flete" value="<?= $all_remisiones_complete_id['destino_flete']; ?>" readonly>                
                </div>
                <!--
                <label for="cajas" class="col-sm-1 control-label">Cajas</label>
                <div class="col-sm-3">
					<input type="text" name="cajas_flete" class="form-control" id="cajas_flete" value="<?//= $all_remisiones_complete_id['cajas_flete'] ?>" >                
                </div>
                -->
          ...
          <input type="text" name="cargado_externo" class="form-control" id="cargado_externo">
                ...
                <div class="col-sm-3">
                  <select name="tipo_flete" id="tipo_flete" class="form-control" value="<?= $all_remisiones_complete_id['tipo_flete']; ?>" >
...
<div class="green box">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="ticket_bascula" class="form-control" id="ticket_bascula" value="<?= $all_remisiones_complete_id['ticket_bascula']; ?>" placeholder="Ticket Báscula" readonly>                
          </div>
                <label for="toneladas_remision" class="col-sm-2 control-label">Toneladas</label>
                <div class="col-sm-4">
					<input type="text" name="toneladas_remision" class="form-control peso_monto" id="toneladas_remision"  value="<?= $all_remisiones_complete_id['toneladas_remision']; ?>" readonly>                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="peso_final" class="form-control peso_monto" id="peso_final" value="<?= $all_remisiones_complete_id['peso_final']; ?>">                
                </div>

              </div>

<!-- Aregar filtro para solo admins/ventas -->
              <div class="form-group">
                <label for="monto_total_remision" class="col-sm-2 control-label">Monto Total</label> 
                <div class="col-sm-4">
                <?php 
				$monto_total_remision = ($all_remisiones_complete_id['peso_final'] - $all_remisiones_complete_id['peso_inicial'])*$all_remisiones_complete_id['precio_tonelada']; 
				?>
