    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Nueva Remisión - Espuela</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body ">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
			...
			<?php echo form_open(base_url('admin/remisiones/add_espuela/'), 'class="form-horizontal"' )?>            
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" name="fecha_remision" class="form-control" id="fecha_remision" value="<?php echo date('Y-m-d - h:i:s'); ?>" readonly>
                </div>
          ...
          <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="salida_flete" class="form-control" id="salida_flete" value="<?php echo date('Y-m-d - h:i:s'); ?>" readonly> 
                <?php } else { ?>
