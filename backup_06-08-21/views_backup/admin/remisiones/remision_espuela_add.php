			...
			<?php echo form_open(base_url('admin/remisiones/add/'), 'class="form-horizontal"' )?>            
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="fecha_remision" class="form-control" id="datepicker" required>
                  </div>
                  </div>
...
<div class="green box">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="toneladas_remision" class="form-control peso_monto" id="toneladas_remision" required readonly>                
                </div>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Agregar Remision" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
