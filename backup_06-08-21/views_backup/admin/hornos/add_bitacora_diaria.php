                ...
                <div class="box-body">
                    ...
                    <div id="body-h1-h2" style="display:none">
                        ...
                        <div id="temp-horno-2" style="display:none;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" step="any" min="0" name="temperatura_diferencia" class="form-control" id="temperatura_diferencia" >
                                </div>
                    ...
                    <div id="body-h3" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="number" step="any" min="0" name="h3_gas_presion_horno_arriba" id="h3_gas_presion_horno_arriba" class="form-control">
                            </div>
                        </div>
