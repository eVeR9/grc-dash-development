...
<!-- displaying the dropdown list -->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="any" name="toneladas" class="form-control calcular" id="toneladas" placeholder="" required>
                </div>
                
                <label for="dias_habiles" class="col-sm-2 control-label">Días Hábiles</label>
                <div class="col-sm-4">
                    <input type="number" step="0.01" name="dias_habiles" class="form-control calcular" id="dias_habiles" min="1.00" max="31.00" placeholder="" required>
                </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="any" name="meta_diaria" class="form-control" id="meta_diaria" placeholder="" required readonly>
                </div>
                
                <label for="meta_semanal" class="col-sm-2 control-label">Meta Semanal</label>
                <div class="col-sm-4">
                    <input type="any" name="meta_semanal" class="form-control" id="meta_semanal" placeholder="" required readonly>
                </div>
                </div>
