            ...
            <div class="box">   
                ...
                <?php echo  form_open(base_url('admin/trituracion/bitacora_add/'), 'class="form-horizontal"'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="fecha" class="form-control daterange" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula1" class="form-control bascula">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="text" step="any" name="toneladas_bascula2" class="form-control bascula">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula3" class="form-control bascula">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                        <select name="id_material_bascula4" id="id_material_bascula4" class="form-control" >
                                <option value="">Seleccione Material</option>
                                <?php foreach($all_materiales as $row): ?>
                                    <option value="<?= $row['id']; ?>"><?= $row['nombre_del_material']; ?></option>
                                <?php endforeach; ?>
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula4" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                        <select name="id_material_bascula5" id="id_material_bascula5" class="form-control" >
                                <option value="">Seleccione Material</option>
                                <?php foreach($all_materiales as $row): ?>
                                    <option value="<?= $row['id']; ?>"><?= $row['nombre_del_material']; ?></option>
                                <?php endforeach; ?>
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula5" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                        <select name="id_material_bascula6" id="id_material_bascula6" class="form-control" >
                                <option value="">Seleccione Material</option>
                                <?php foreach($all_materiales as $row): ?>
                                    <option value="<?= $row['id']; ?>"><?= $row['nombre_del_material']; ?></option>
                                <?php endforeach; ?>
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula6" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                        <select name="id_material_bascula7" id="id_material_bascula7" class="form-control" >
                                <option value="">Seleccione Material</option>
                                <?php foreach($all_materiales as $row): ?>
                                    <option value="<?= $row['id']; ?>"><?= $row['nombre_del_material']; ?></option>
                                <?php endforeach; ?>
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula7" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                        <select name="id_material_bascula8" id="id_material_bascula8" class="form-control" >
                                <option value="">Seleccione Material</option>
                                <?php foreach($all_materiales as $row): ?>
                                    <option value="<?= $row['id']; ?>"><?= $row['nombre_del_material']; ?></option>
                                <?php endforeach; ?>
                        ...
                        <label for="" class="col-md-1 control-label"></label>
                        <div class="col-md-4">
                            <input type="number" step="any" name="toneladas_bascula8" class="form-control">
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
