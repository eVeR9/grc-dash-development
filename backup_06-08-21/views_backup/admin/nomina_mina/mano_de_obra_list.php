...
<section class="content">
    <div class="box">
        ...
        <a href="<?= base_url('admin/nomina_mina/mano_de_obra_add'); ?>">
                ...
                <tbody>
                    <?php foreach ($gastos_comercial_list as $row) : ?>
                        <tr>
                            ...
                            <td class="text-right"><a href="<?= base_url('admin/nomina_mina/mano_de_obra_edit/' . $row['id']); ?>" class="btn btn-info btn-flat">Editar</a></td> 
