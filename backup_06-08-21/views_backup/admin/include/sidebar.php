    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li>
            <a href="#"><i class="fa fa-users"></i> Inventario
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li id="inv_entrada"><a href="<?= base_url('admin/hornos/entradas_inventario'); ?>"><i class="fa fa-book"></i> Entrada Inv. </a></li>
              <li id="inv_entrada"><a href="<?= base_url('admin/hornos/inventario'); ?>"><i class="fa fa-book"></i> Inventario </a></li>
            </ul>
          </li> <!-- end trituracion -->
      ...
      <li class="treeview">
        ...
        <li>
            ...
            <ul class="treeview-menu">
              ...
              <li id="inv_inicial"><a href="<?= base_url('admin/hornos/bitacora_diaria_h1'); ?>"><i class="fa fa-book"></i> Horno 1 </a></li>
              <li id="inv_entrada"><a href="<?= base_url('admin/hornos/bitacora_diaria_h2'); ?>"><i class="fa fa-book"></i> Horno 2 </a></li>
              <li id="inv_entrada"><a href="<?= base_url('admin/hornos/bitacora_diaria_h3'); ?>"><i class="fa fa-book"></i> Horno 3</a></li>
            </ul>
          </li>
          
          <li>
            <a href="#"><i class="fa fa-folder-open"></i> Ajuste
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li id="inv_inicial"><a href="<?= base_url('admin/hornos/ajuste_inventario'); ?>"><i class="fa fa-book"></i> Inv. Inicial / Ajuste </a></li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul class="treeview-menu">
              <li id="inv_inicial"><a href="<?= base_url('admin/hornos/add_paros'); ?>"><i class="fa fa-book"></i> Agregar Paro</a></li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul class="treeview-menu">
              <li id="inv_inicial"><a href="<?= base_url('admin/hornos/add_programacion_hornos'); ?>"><i class="fa fa-book"></i> Agregar Programacion</a></li>
            </ul>
          </li>

          <li>
            <a href="#"><i class="fa fa-folder-open"></i> Tolvas
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li id="inv_inicial"><a href="<?= base_url('admin/hornos/add_balance_tolvas'); ?>"><i class="fa fa-book"></i> Agregar Balance</a></li>
            </ul>
          </li>
