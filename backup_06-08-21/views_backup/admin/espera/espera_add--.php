        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Camiones en espera</h3>
                </div> <!-- box header -->
                <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="hidden" class="form-control" name="id_estatus" id="id_estatus" value="1" >
                    </div>

                    <label for="" class="col-md-1 control-label">Ticket Entrada</label>
                    <div class="col-md-3">
                        <input type="text" name="id_espera" id="id_espera" value="<?php echo $next_id;?>" class="form-control" readonly>
                    </div>
                    </div>
