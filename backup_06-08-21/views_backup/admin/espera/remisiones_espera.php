 ...
 <section class="content">
   <div class="box">
    <div class="box-header">
      <h3 class="box-title">Entradas Vigilancia</h3>
    </div>
    <?php if($isVigilancia): ?>
      <a href="<?= base_url('admin/vigilancia/add_espera/');?>"><i class="fa fa-plus plus" aria-hidden="true"></i></a>&nbsp&nbsp<label for="" class="">Nueva Remision</label>
    <?php endif;?>
    <!-- /.box-header -->
    <div class="box-body table-responsive">
      <table id="example1" class="table table-bordered table-striped " style="width:100%">
        ...
        <tr>
          ...
          <th style="width: 75px;" class="text-center">Material</th>
          ...
          <th style="width: 120px;" class="text-center">Fecha y Hora</th>
        ...
        <?php foreach($remisiones_espera as $row):?>
          <tr class="fila" id="fila">
            ...
            <td class="center"><?= $row['select_material']?></td>
            <td class="center"><?= $row['select_cliente']?></td>
            <td class="center"><?= $row['nombre_operador_flete']?></td>
            <td class="center"><?= $row['nombre_flete']?></td>
            <td class="center"><?= $row['fecha_espera']?></td>
            <td class="center" style="position:relative"><a href="<?php echo base_url('admin/remisiones/cambiar_estatus_en_espera/'.$row['id']);?>" style="display:block;"><input type="checkbox" class="" name="" onclick="chkboxcolorrow(this)">
            </a></td>
            <td class="center">
            <a href="<?php echo base_url('admin/remisiones/cambiar_estatus_en_espera_cancelar/'.$row['id']); ?>">
            <input type="button" value="Cancelar" class="btn btn-info btn-sm" name="checkbox1" id="prueba" onclick="hideRow(this);"/>
            </a>
            </td>
            <!--
