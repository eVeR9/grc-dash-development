...
<script>
$(function() {
    $('#fecha_remision').daterangepicker({
      ...
      <div class="box">
        ...
        <div class="box-body ">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
			...
			<?php echo form_open(base_url('admin/vigilancia/add/'), 'class="form-horizontal"' )?>            
              <div class="form-group">
                ...
                <div class="input-group" >
                  ...
                  <input type="text" autocomplete="off" name="fecha_remision" class="form-control" id="fecha_remision" required>
                  
                  </div>
                  </div>
                <label for="estatus_pedido" class="col-sm-2 control-label">Fase de Espera</label>

                <div class="col-sm-4">
                  <select name="id_fase_de_remision" id="id_fase_de_remision" class="form-control" required>
                    <option value="">Selecciona Fase</option>
                  <?php foreach($remisiones_fases_espera as $row): ?>
                  <?php
				  	$selected=""; 
...
<script>
    ...
    function get_values()
    {
		...
		if(id != 0) { //CON PEDIDO
                 $.ajax({
                    url : "<?php echo base_url();?>admin/vigilancia/get_pedido/"+id,
                    method : "POST",
                    data : {id: id},
                    async : true,
                    dataType : 'json',
