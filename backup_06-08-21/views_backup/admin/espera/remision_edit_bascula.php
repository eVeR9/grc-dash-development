...
<section class="content">
    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Editar Remisión | Bascula - Remisión: <?= $all_remisiones_complete_id['id_serie']?></h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body ">
			...
			<?php echo form_open(base_url('admin/remisiones/edit/'.$all_remisiones_complete_id['id']), 'class="form-horizontal"' )?>    
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="fecha_remision" class="form-control" required value="<?= $all_remisiones_complete_id['fecha_remision']; ?>">
                  </div>
                  </div>
                ...
                <input type="text" name="id_pedido2" class="form-control" id="id_pedido2" value="<?php if(!empty($all_remisiones_complete_id['id_pedido'])) { echo $all_remisiones_complete_id['id_pedido'] . ' - ' . $all_remisiones_complete_id['razon_social'];} else echo 'Sin pedido'; ?>" readonly required>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="text" name="nombre_del_material" id="nombre_del_material"  class="form-control"  value="<?php echo $all_remisiones_complete_id['nombre_del_material']; ?>" required readonly> 
                    <!.-- Preguntarle a Jon sobre este otro input de material -->
                    <!--
					<input name="nombre_del_material" type="hidden" required class="form-control" id="nombre_del_material" value="">
 ...
 -->               
					<input type="hidden" class="form-control peso_monto" name="precio_tonelada" id="precio_tonelada" value="<?php echo $all_remisiones_complete_id['precio_tonelada']; ?>"  >                
					<input type="hidden" name="monto_total_pedido" class="form-control peso_monto" id="monto_total_pedido" value="<?php echo $all_remisiones_complete_id['monto_total']; ?>"  >                
          ...
          <input type="text" name="cargado_externo" class="form-control" id="cargado_externo">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                	<textarea name="notas_remision" class="form-control" id="notas_remision" ><?= $all_remisiones_complete_id['notas_remision']; ?></textarea>
                </div>
              </div>
...
<div class="green box">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="ticket_bascula" class="form-control" id="ticket_bascula" value="<?= $all_remisiones_complete_id['ticket_bascula']; ?>" required placeholder="Ticket Báscula" readonly>                
          </div>
                <label for="toneladas_remision" class="col-sm-2 control-label">Toneladas</label>
                <div class="col-sm-4">
					<input type="text" name="toneladas_remision" class="form-control peso_monto" id="toneladas_remision" required readonly value="<?= $all_remisiones_complete_id['toneladas_remision']; ?>">                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="peso_inicial" class="form-control peso_monto" id="peso_inicial" value="<?= $all_remisiones_complete_id['peso_inicial']; ?>" required style="margin-bottom:10px;">                
                </div>

                <label for="peso_final" class="col-sm-2 control-label">Peso Final</label>
                <div class="col-sm-4">
					<input type="number" step="any" name="peso_final" class="form-control peso_monto" id="peso_final" value="<?= $all_remisiones_complete_id['peso_final']; ?>"  style="margin-bottom:10px;">                
                </div>
...
<?php } ?>
              ...
              <div class="form-group">
                ...
                <input type="submit" name="submit" value="Editar Remision" class="btn btn-info pull-right" id="btnsubmit" >
                </div>
              </div>
            <?php echo form_close(); ?> 
          </div>
...
jQuery('body').on('input','input.peso_monto',function(){
	   ...
	   var result_monto;
	   var toneladas_restantes;
	   var serie;
	   var id_pedido;
	   var toneladas_pedido;
	   var toneladas_embarcadas;
	   serie = $('#serie').val();
	   id_pedido = parseFloat($('#id_pedido').val());
	   toneladas_pedido = parseFloat($('#toneladas_pedido').val());
	   toneladas_embarcadas = parseFloat($('#toneladas_embarcadas').val());
	   toneladas_restantes = toneladas_pedido - toneladas_embarcadas;
	   ...
	   //Checamos si las toneladas restantes del pedido son suficientes para esta remision 
	   if(serie == "G" && id_pedido > 0){
	   if(toneladas_restantes < result_peso){
		   alert("El monto de las toneladas excede las toneladas restantes, favor de checar con vendedor.");
