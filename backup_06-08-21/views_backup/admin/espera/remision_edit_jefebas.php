    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Editar Remision | Jefe Bascula - Remision: <?= $all_remisiones_complete_id['id']?></h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body ">
          ...
          <input type="text" name="cargado_externo" class="form-control" id="cargado_externo">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                	<textarea name="notas_remision" class="form-control" id="notas_remision" value=""  placeholder="Anotaciones"><?= $all_remisiones_complete_id['notas_remision']; ?></textarea>
                </div>
              </div>
...
<div class="green box">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="ticket_bascula" class="form-control" id="ticket_bascula" value="<?= $all_remisiones_complete_id['ticket_bascula']; ?>" required placeholder="Ticket Báscula">                
          </div>
                <label for="toneladas_remision" class="col-sm-2 control-label">Total Toneladas</label>
                <div class="col-sm-4">
					<input type="text" name="toneladas_remision" class="form-control peso_monto" id="toneladas_remision" value="<?= $all_remisiones_complete_id['toneladas_remision']; ?>" required readonly>                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="peso_inicial" class="form-control peso_monto" id="peso_inicial" value="<?= $all_remisiones_complete_id['peso_inicial']; ?>" required>                
                </div>

                <label for="peso_final" class="col-sm-2 control-label">Peso Final</label>
                <div class="col-sm-4">
					<input type="number" step="any" name="peso_final" class="form-control peso_monto" id="peso_final" value="<?= $all_remisiones_complete_id['peso_final']; ?>">                
                </div>
