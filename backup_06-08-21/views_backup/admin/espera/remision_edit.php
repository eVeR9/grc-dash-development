    ...
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body ">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
			...
			<?php echo form_open(base_url('admin/remisiones/edit/'.$all_remisiones_complete_id['id']), 'class="form-horizontal"' )?>    
              ...
              <div class="form-group">
                ...
                <input type="text" name="id_pedido2" class="form-control" id="id_pedido2" value="<?php if(!empty($all_remisiones_complete_id['id_pedido'])) { echo $all_remisiones_complete_id['id_pedido'] .' - '.$all_remisiones_complete_id['razon_social'];} else echo 'Sin pedido'; ?>">
                </div>
                ...
                <div class="col-sm-5">
                  ...
                  <input type="text" name="registro_patronal_re" class="form-control" id="registro_patronal_re" value="<?php echo $all_remisiones_complete_id['razon_social_re'] ?>" >
                </div>
              </div>
          ...
          <input type="text" name="razon_social" class="form-control" id="razon_social"  value="<?php echo $all_remisiones_complete_id['razon_social']; ?>" > 
                </div>

                <label for="orden_de_compra" class="col-sm-2 control-label">Orden de Compra:</label>
                <div class="col-sm-4">
					<input type="text" name="orden_de_compra" id="orden_de_compra" class="form-control" value="<?php if(!empty($all_remisiones_complete_id['id_pedido'])) { echo $all_remisiones_complete_id['orden_de_compra']; } else { echo $all_remisiones_complete_id['orden_de_compra_remision']; } ?>" >
                </div>
              ...
              <div class="form-group">
                ...
                <input name="sucursal" type="text"  class="form-control" id="sucursal" value="<?php echo $all_remisiones_complete_id['sucursal']; ?>">                
                </div>
            ...
            value="<?php 
                      if(!empty($all_remisiones_complete_id['id_pedido'])){ 
                          echo $all_remisiones_complete_id['obra_cliente'];
                        } else{ 
                            echo $all_remisiones_complete_id['obra_cliente_remision'];
                          }
                   ?>" >                
            </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <input type="text" name="vendedor" id="vendedor" class="form-control" value="<?php echo $all_remisiones_complete_id['nombre_vendedor'];  ?>" >                
                </div>
               ...
               <!--
                ...
                <select name="select_material"  class="form-control" id="select_material" onchange="change_material();">
                    <option value="">Seleccione otro material</option>
                  <?php foreach($materiales as $row): ?>
                  
                  <?php
				  	$selected=""; 
				  	if($row['id']==$all_remisiones_complete_id['id_material']){$selected="selected";}
				   ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                <textarea name="notas" id="notas" class="form-control" ><?php echo $all_remisiones_complete_id['notas']; ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" class="form-control peso_monto" name="precio_tonelada" id="precio_tonelada" value="<?php echo $all_remisiones_complete_id['precio_tonelada']; ?>" >                
                </div>
                <label for="monto_total" class="col-sm-2 control-label">Monto Total</label>

                <div class="col-sm-4">
					<input type="text" name="monto_total_pedido" class="form-control peso_monto" id="monto_total_pedido" value="<?php echo $all_remisiones_complete_id['monto_total']; ?>" >                
                </div>
              </div>
               <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
					<input type="text" name="toneladas_pedido" class="form-control" id="toneladas_pedido" value="<?php echo $all_remisiones_complete_id['toneladas']; ?>" >                
                </div>
 
                 <label for="toneladas_embarcadas" class="col-sm-2 control-label">Toneladas Embarcadas</label>

                <div class="col-sm-2">
					<input type="text" name="toneladas_embarcadas" class="form-control" id="toneladas_embarcadas" value="<?php echo $all_remisiones_complete_id['toneladas_embarcadas']; ?>" >                
                </div>

                
                <label for="toneladas_restantes" class="col-sm-2 control-label">Toneladas Restantes</label>
                <div class="col-sm-2">
					<input type="text" name="toneladas_restantes" class="form-control" id="toneladas_restantes" value="<?php echo ($all_remisiones_complete_id['toneladas'] - $all_remisiones_complete_id['toneladas_embarcadas']); ?>" >               
                </div>
				</div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
					<input type="text" name="nombre_flete" class="form-control" id="nombre_flete" value="<?= $all_remisiones_complete_id['nombre_flete']; ?>" >                
                </div>
                
                <label for="flete_operador" class="col-sm-1 control-label">Operador</label>
                <div class="col-sm-3">
					<input type="text" name="nombre_operador_flete" class="form-control" id="nombre_operador_flete" value="<?= $all_remisiones_complete_id['nombre_operador_flete']; ?>" >                
                </div>
                
                <label for="flete_placas" class="col-sm-1 control-label">Placas</label>
                <div class="col-sm-3">
					<input type="text" name="placas_flete" class="form-control" id="placas_flete" value="<?= $all_remisiones_complete_id['placas_flete']; ?>"  >                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
					<input type="text" name="entrada_flete" class="form-control" id="entrada_flete" value="<?= $all_remisiones_complete_id['entrada_flete']; ?>" >                
                </div>

                <label for="salida" class="col-sm-2 control-label">Hora Salida</label>
                <div class="col-sm-2">
					<input type="text" name="salida_flete" class="form-control" id="salida_flete" value="<?= $all_remisiones_complete_id['salida_flete']; ?>">                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
					<input type="text" name="destino_flete" class="form-control" id="destino_flete" value="<?= $all_remisiones_complete_id['destino_flete']; ?>" >                
                </div>
                <!--
...
<div class="green box">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="ticket_bascula" class="form-control" id="ticket_bascula" value="<?= $all_remisiones_complete_id['ticket_bascula']; ?>" placeholder="Ticket Báscula" >                
          </div>
                <label for="toneladas_remision" class="col-sm-2 control-label">Toneladas</label>
                <div class="col-sm-4">
					<input type="text" name="toneladas_remision" class="form-control peso_monto" id="toneladas_remision"  value="<?= $all_remisiones_complete_id['toneladas_remision']; ?>">                
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
					<input type="text" name="peso_inicial" class="form-control peso_monto" id="peso_inicial" value="<?= $all_remisiones_complete_id['peso_inicial']; ?>" >                
                </div>
