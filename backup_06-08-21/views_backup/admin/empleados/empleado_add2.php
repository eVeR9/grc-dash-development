          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/empleados/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" name="estado" class="form-control" id="estado" placeholder="" value="Nuevo León">
                </div>
                <label for="pais" class="col-sm-1 control-label">País</label>

                <div class="col-sm-3">
                  <input type="text" name="pais" class="form-control" id="pais" value="México">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="fecha_de_nacimiento" class="form-control" id="fecha_de_nacimiento" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" name="curp" class="form-control" id="curp" placeholder="">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" name="imss" class="form-control" id="imss" placeholder="">
                </div>
                <label for="ife" class="col-sm-1 control-label">IFE</label>

                <div class="col-sm-3">
                  <input type="text" name="ife" class="form-control" id="ife" placeholder="">
                </div>                
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="fecha_ingreso" class="form-control" id="fecha_ingreso" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                  </div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="fecha_salida" class="form-control" id="fecha_salida" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <?php foreach($all_puestos as $row): ?>
                    <option value="<?= $row['id']; ?>"><?= $row['nombre_del_puesto']; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>                
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="id_registro_patronal" class="form-control">
