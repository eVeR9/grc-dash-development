      ...
      <div class="box">
        ...
        <div class="box-body ">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="number" step="any" name="salario_neto" id="salario_neto" class="form-control">
            </div>

            <label for="id_frecuencia_pago" class="col-sm-2 control-label">S. Neto Diario</label>

            <div class="col-sm-4">
              <input type="number" name="salario_neto_diario" id="salario_neto_diario" class="form-control" readonly>
            </div>
          </div>
...
<script>
    //let salarioNeto = document.getElementById('salario_neto').value

    //salario = $('#salario_neto').val()

    $( "#salario_neto" ).on('keyup', function() {

      salario = $( "#salario_neto" ).val()
      dias = 30
      salario_diario = salario / dias
      
      $( "#salario_neto_diario" ).val(salario_diario.toFixed(2));

  });

    $('#salario_neto').on('keyup', function() {

      salario_neto = $('#salario_neto').val();
      dias_salario = 30;
      porcentaje = 0.50;
      calculo = (salario_neto/dias_salario)*porcentaje;

      $('#salario_neto_diario_50').val(calculo.toFixed(2));
