...
public function conceptos_list(){
    ...
    /* Graficas de Tiempo Real de Basculas */
    public function trituracion_tiempo_real(){
        $data['bascula1'] = $this->trituracion_model->get_bascula1();
        $data['bascula2'] = $this->trituracion_model->get_bascula2();
        $data['bascula3'] = $this->trituracion_model->get_bascula3();
        //$grafica = $this->trituracion_model->get_basculas_tiempo_real();
        $data['grafica'] = json_encode($this->trituracion_model->get_basculas_tiempo_real()->result());
        $data['tiempo_real'] = $this->trituracion_model->get_basculas_tiempo_real();
        $data['view'] = 'admin/trituracion/trituracion_basculas_tiempo_real';
        $this->load->view('admin/layout', $data);
    }
