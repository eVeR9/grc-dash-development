...
function Lists()
{
    ...
    public function ajax_list()
    {
       ...
       echo json_encode($output);
		...
		public function add(){
			if($this->input->post('submit')){
				...
				if ($this->form_validation->run() == FALSE) {
					//$data['camiones'] = $this->remision_model->camiones_espera();
					$data['next_id'] = $this->remision_model->next_id();
		...
		public function add_espuela(){
			if($this->input->post('submit')){
				...
				if ($this->form_validation->run() == FALSE) {
					...
					$data['all_pedidos_complete'] =  $this->remision_model->get_all_pedidos_complete();
					$data['all_sucursales'] =  $this->remision_model->get_all_sucursales();					
					$data['view'] = 'admin/remisiones/remision_add_espuela';
					$this->load->view('admin/layout', $data);
				}
				else{
					$serie = $this->input->post('serie');
					...
					$data = array(
						'toneladas_remision' => $this->input->post('toneladas_remision'), //ESPUELA
						'monto_total_remision' => $monto_total_remision, //ESPUELA
						'serie' => $this->input->post('serie'),
						'id_serie' => $this->input->post('id_serie'),
						'fecha_remision' => $this->input->post('fecha_remision'),
						'id_pedido' => $this->input->post('id_pedido'),
		...
		public function add_remision_espera($id=0){
			if($this->input->post('submit')){
				...
				if ($this->form_validation->run() == FALSE) { //SI ALGO DE LA INFO ESTA MAL, NOS REGRESA A LA CAPTURA DE LA REMISION-VIGILANCIA
					$data['camiones'] = $this->remision_model->camiones_espera();
					$data['next_id'] = $this->remision_model->next_id();
					$data['next_id_a'] = $this->remision_model->next_id_a();
					$data['next_id_e'] = $this->remision_model->next_id_e();
					...
					$data['all_pedidos_complete'] =  $this->remision_model->get_all_pedidos_complete();
					$data['all_sucursales'] =  $this->remision_model->get_all_sucursales();					
					$data['remision_espera_id'] =  $this->remision_model->get_remision_espera_by_id($id);
					$data['view'] = 'admin/remisiones/remision_add_espera';
					$this->load->view('admin/layout', $data);
				}
					...
					$data = array(
						'peso_inicial' => $this->input->post('peso_inicial'), //EDIT
						...
						'id_folio_espera' => $this->input->post('id_folio_espera'), //hidden
						//'obra_cliente' => $this->input->post('obra_cliente'),
						//'orden_de_compra' => $this->input->post('orden_de_compra'),
						//'id_sucursal' => $this->input->post('id_sucursal'),
						//'txt_sucursal' => $this->input->post('txt_sucursal'),
					...
					$result_update_espera = $this->remision_model->edit_remision($data, $id); //editar tabla remision_espera
  ...
  public function getClienteSucursales(){
    ...
    echo json_encode($data); 
  	...
  	public function remisiones_espera(){
		//$id = " ";
		//$data['remisiones_espera_id'] = $this->remision_model->get_remisiones_espera_by_id($id);
		//var_dump($data);
		$data['remisiones_espera'] = $this->remision_model->get_remisiones_espera();
		//var_dump($data);
  	...
  	public function get_remision_espera_by_id(){
		//$id = " ";
		$data['get_remisiones_espera_by_id'] = $this->remision_model->get_remision_espera_by_id();
		//var_dump($data);
		$data['view'] = 'admin/remisiones/remisiones_espera';
		$this->load->view('admin/layout', $data);
	  ...
	  function get_remision_espera($id){
        $data = $this->remision_model->get_remision_espera($id);
        echo json_encode($data);
		$this->db->last_query();
    }
	...
	public function add_espera() {
		if($this->input->post('submit')){
			$this->form_validation->set_rules('nombre_flete', 'nombre_flete', 'trim');
			...
			if($this->form_validation->run() == FALSE) {
				...
				$data['all_clientes'] =  $this->remision_model->get_all_clientes();
				$data['all_pedidos_complete'] =  $this->remision_model->get_all_pedidos_complete();
				$data['view'] = 'admin/remisiones/add_espera';
				$this->load->view('admin/layout', $data);
				//var_dump($data);
			} 
			else {
				$data = array(
					...
					'id_espera' => $this->input->post('id_espera'),
					'nombre_flete' => $this->input->post('nombre_flete'),
					'nombre_operador_flete' => $this->input->post('nombre_operador_flete'),
					'placas_flete' => $this->input->post('placas_flete'),
					'entrada_flete' => $this->input->post('entrada_flete'),
					...
					'notas_remision' => $this->input->post('notas_remision'),
					'id_pedido' => $this->input->post('id_pedido'),
					'select_material' => $this->input->post('id_material'),
					'select_cliente' => $this->input->post('id_cliente'),
				);
				$data = $this->security->xss_clean($data);
				$result = $this->remision_model->add_remision_espera($data);
	...
	public function cambiar_estatus_en_espera($id = 0){
		$data = $this->remision_model->cambiar_estatus_a_entrada($id);
		redirect(base_url('admin/remisiones/remisiones_espera'));
		//$data['view'] = 'admin/remisiones/remisiones_espera';
		//$this->load->view('admin/layout', $data);
		//var_dump($data);
	}
	...
	public function cambiar_estatus_en_espera_cancelar($id = 0){
		$data = $this->remision_model->cambiar_estatus_a_cancelar($id);
		redirect(base_url('admin/remisiones/remisiones_espera'));
	}
